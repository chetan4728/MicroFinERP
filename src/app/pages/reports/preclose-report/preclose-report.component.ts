...
@Component({
  selector: 'app-preclose-report',
  templateUrl: './preclose-report.component.html',
  styleUrls: ['./preclose-report.component.scss']
})
export class PrecloseReportComponent implements OnInit {
  ...
  viewForm(data): void {
    this.router.navigate(['/preclose-report/view-preclose/' + data.branch_id +'/' +data.area_id +'/' +data.center_id +'/' +data.group_id +"/view/"+data.disbursment_number]);    
  }
